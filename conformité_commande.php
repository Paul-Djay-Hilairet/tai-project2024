...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='modifier_évaluation.php?id=" . $row['id'] . "'>Modifier</a></td>";
...
<div class="w3-bar">
    <a href="ajouter_évalution_conformité.php" class="w3-bar-item w3-button tablink">Ajouter une évaluation conformité</a>
</div>
